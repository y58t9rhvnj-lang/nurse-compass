...
const CHART_E: ChartData = {
  clinicalRecords: [
    ...
    { date: "2025/07/08", time: "07:10", profession: "看護", author: "看護師 佐々木", nursingRecordId: "nursing-e-20250708-01", content: "【看護記録】早朝4:30に覚醒し以降入眠できず臥床。「夜が長くてつらい」と訴え。朝食は6割にとどまる。傾聴し、日中の活動を一緒に確認。" },
...
const CHART_F: ChartData = {
  clinicalRecords: [
    ...
    { date: "2025/07/07", time: "11:00", profession: "医師", author: "高橋 誠 医師", medicationChangeId: "rx-f-20250707-teiki", content: "【精神科 経過記録】気分安定期。服薬コンプライアンス良好。退院後のフォロー体制について話し合い。リチウムは治療域を維持し、定期処方（炭酸リチウム・ラモトリギン）を継続する。" },
